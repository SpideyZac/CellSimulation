...
pub const DEFAULT_FOOD_VALUE: f32 = 15.0;
...
pub const CELL_STARTING_FOOD: f32 = 100.0;
...
pub const DEFAULT_ADD_CODON_MUTATION_RATE: f32 = 0.01;
pub const DEFAULT_REMOVE_CODON_MUTATION_RATE: f32 = 0.001;
pub const DEFAULT_FOOD_TO_REPLICATE: f32 = 115.0;
pub const DEFAULT_CELL_SIZE_SQ: f32 = 4.0;

pub const FOOD_USED_PER_FRAME: f32 = 0.2;
pub const FOOD_STOLEN_PER_TOXIN_UNIT: f32 = 1.0;
